                        ...
                        <form onSubmit={handleSignUp}>
                            <div className="flex gap-3">
                                ...
                                <div className="form-control">
                                    ...
                                    <input type="email" name='email' placeholder="email" className="input input-bordered bg-slate-200 text-black" />
                                </div>
                            </div>
                            <div className="form-control">
                                <label className="label">
                            ...
                            <div className="form-control mt-6">
                                <input type="submit" className="btn border-white bg-white text-lime-600" value="SignUp" />
                            </div>
                        </form>
                        <div><button onClick={handleGoogleSignIn} className='btn btn-block mt-3 bg-white border-white text-lime-600'><FaGoogle />With Google</button></div>
                        <p className='my-4 text-center text-gray-700'>Have an account? <Link to='/login' className='text-lime-900 font-bold'>Login</Link></p>
                    </div>
                </div>
            </div>
        </div>
