                    ...
                    <div className="card-body bg-lime-300 rounded-lg">
                        ...
                        <form onSubmit={handleLogin}>
                            ...
                            <div className="form-control mt-6">
                                <input type="submit" className="btn border-white bg-white text-lime-600" value="Login" />
                            </div>
                        </form>
                        ...
                        <p className='my-4 text-center text-gray-700'>New to EduLE? <Link to='/signUp' className='text-lime-700 font-bold'>SignUp</Link></p>
                    </div>
                </div>
            </div>
        </div>
